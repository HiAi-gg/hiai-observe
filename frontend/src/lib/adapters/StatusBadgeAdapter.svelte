<script lang="ts">
// StatusBadgeAdapter — wraps @hiai-gg/hiai-ui StatusBadge, preserving local API.
//
...
//   size:   "sm" | "md"
//
// Canonical @hiai-gg/hiai-ui StatusBadge:
...
// The canonical name is used to look up the badge color in @hiai-gg/hiai-ui, but
...
import { StatusBadge } from "@hiai-gg/hiai-ui";
